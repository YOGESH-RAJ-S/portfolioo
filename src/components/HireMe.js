...
const HireMe = () => {
  return (
    ...
    flex items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute 2xl:absolute
    sm:right-0
    '>
        <div className='w-48 h-auto items-center justify-center relative md:w-24'>
            ...
            <a href="mailto:yogeshraj1470@gmail.com" className='flex items-center justify-center
